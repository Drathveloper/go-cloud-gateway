...
func TestPool_ValidateJSON(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			input: "{\"timeout\":\"10s\",\"max-idle-conns\":10,\"max-idle-conns-per-host\":15,\"max-conns-per-host\":20,\"idle-conn-timeout\":\"15s\",\"tls-handshake-timeout\":\"20s\",\"keep-alive\":\"30s\",\"response-header-timeout\":\"10s\"}",
			expected: config.Pool{
		...
		},
		{
			...
			input: "{\"max-idle-conns\":10,\"max-idle-conns-per-host\":15,\"max-conns-per-host\":20,\"idle-conn-timeout\":\"15s\",\"tls-handshake-timeout\":\"20s\",\"keep-alive\":\"30s\",\"response-header-timeout\":\"10s\"}",
			expected: config.Pool{
				MaxIdleConns:          10,
				MaxIdleConnsPerHost:   15,
				MaxConnsPerHost:       20,
			...
			expectedErr: errors.New("Key: 'Pool.Timeout' Error:Field validation for 'Timeout' failed on the 'required' tag"),
		},
		{
			name:  "unmarshal and validate should succeed when input is valid and max idle conns is empty",
			input: "{\"timeout\":\"10s\",\"max-idle-conns-per-host\":15,\"max-conns-per-host\":20,\"idle-conn-timeout\":\"15s\",\"tls-handshake-timeout\":\"20s\",\"keep-alive\":\"30s\",\"response-header-timeout\":\"10s\"}",
			expected: config.Pool{
				Timeout:               &config.Duration{Duration: 10 * time.Second},
				MaxIdleConnsPerHost:   15,
				MaxConnsPerHost:       20,
		...
		},
		{
			...
			input: "{\"timeout\":\"10s\",\"max-idle-conns\":10,\"max-conns-per-host\":20,\"idle-conn-timeout\":\"15s\",\"tls-handshake-timeout\":\"20s\",\"keep-alive\":\"30s\",\"response-header-timeout\":\"10s\"}",
			expected: config.Pool{
				Timeout:               &config.Duration{Duration: 10 * time.Second},
				MaxIdleConns:          10,
				MaxConnsPerHost:       20,
		...
		},
		{
			...
			input: "{\"timeout\":\"10s\",\"max-idle-conns\":10,\"max-idle-conns-per-host\":15,\"idle-conn-timeout\":\"15s\",\"tls-handshake-timeout\":\"20s\",\"keep-alive\":\"30s\",\"response-header-timeout\":\"10s\"}",
			expected: config.Pool{
				Timeout:               &config.Duration{Duration: 10 * time.Second},
				MaxIdleConns:          10,
				MaxIdleConnsPerHost:   15,
		...
		},
		{
			...
			input: "{\"timeout\":\"10s\",\"max-idle-conns\":10,\"max-idle-conns-per-host\":15,\"max-conns-per-host\":20,\"tls-handshake-timeout\":\"20s\",\"keep-alive\":\"30s\",\"response-header-timeout\":\"10s\"}",
			expected: config.Pool{
				Timeout:               &config.Duration{Duration: 10 * time.Second},
				MaxIdleConns:          10,
				MaxIdleConnsPerHost:   15,
		...
		},
		{
			...
			input: "{\"timeout\":\"10s\",\"max-idle-conns\":10,\"max-idle-conns-per-host\":15,\"max-conns-per-host\":20,\"idle-conn-timeout\":\"15s\",\"keep-alive\":\"30s\",\"response-header-timeout\":\"10s\"}",
			expected: config.Pool{
				Timeout:               &config.Duration{Duration: 10 * time.Second},
				MaxIdleConns:          10,
				MaxIdleConnsPerHost:   15,
